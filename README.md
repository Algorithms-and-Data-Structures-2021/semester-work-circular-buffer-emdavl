...
- _Кольцевой буфер - буфер фиксированного размера, который работает так, как если бы память была непрерывной и циклической.
  Из названия понятно, что можно сравнить с кольцом_
  ![Image alt](https://github.com/EMDavl/semester-work-circular-buffer-emdavl/raw/main/pics/1024px-Circular_buffer.svg.png)
